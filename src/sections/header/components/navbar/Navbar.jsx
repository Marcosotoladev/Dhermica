...
const Navbar = () => {
  ...
  return (
    <nav className="navbar">
      <div className={`navbar-item ${activeIcon === 'home' ? 'active' : ''}`} onClick={() => handleIconClick('home')}>
      ...
      <div className={`navbar-item ${activeIcon === 'treatments' ? 'active' : ''}`} onClick={() => handleIconClick('treatments')}>
      ...
      <div className={`navbar-item ${activeIcon === 'products' ? 'active' : ''}`} onClick={() => handleIconClick('products')}>
      ...
      <div className={`navbar-item ${activeIcon === 'contact' ? 'active' : ''}`} onClick={() => handleIconClick('contact')}>
